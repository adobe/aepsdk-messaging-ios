...
class MockPropositionItem: PropositionItem {
    ...
    var paramTrackTokens: [String]?
    var trackCalled = false
    override func track(_ interaction: String? = nil, withEdgeEventType eventType: MessagingEdgeEventType, forTokens tokens: [String]? = nil) {
        trackCalled = true
