//
//  FoodDeliveryLiveActivityView.swift
//  MobileTestApp
//
...
private extension FoodDeliveryLiveActivityView {
    ...
    func startLiveActivity() {
        ...
        let attributes = FoodDeliveryLiveActivityAttributes(restaurantName: restaurantName, liveActivityData: AEPLiveActivityData.create(liveActivityID: "orderID123"))
