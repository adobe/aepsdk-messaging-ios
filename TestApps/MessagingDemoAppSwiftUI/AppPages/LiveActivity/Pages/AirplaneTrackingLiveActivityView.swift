//
//  AirplaneTrackingLiveActivityView.swift
//  MobileTestApp
//
//  Created by Pravin Prakash Kumar on 1/13/25.
//
...
private extension AirplaneTrackingLiveActivityView {
    ...
    func startLiveActivity() {
        ...
        let attributes = AirplaneTrackingAttributes(liveActivityData: AEPLiveActivityData.create(liveActivityID: "DELTA35_Jan_20_2025"), arrivalAirport: "SFO", departureAirport: "MIA", arrivalTerminal: "Terminal 2")
    ...
    /// Start a new Live Activity using pushType: .channel
     func startChannelActivity() {
         ...
         // Example attribute + initial content state
         let attributes = AirplaneTrackingAttributes(liveActivityData: AEPLiveActivityData.create(liveActivityID: "ADBAIR_335_Jan_20_2025"), arrivalAirport: "SFO", departureAirport: "MIA", arrivalTerminal: "Terminal 2")
         let initialContentState = AirplaneTrackingAttributes.ContentState(journeyProgress: 0)
